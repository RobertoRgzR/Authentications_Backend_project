...
`;let GitHubApi=class GitHubApi{_onDidReauthenticate=new G.EventEmitter;get onDidReauthenticate(){return this._onDidReauthenticate.event}_disposable;constructor(e){this._disposable=x.H.onDidChangeAny(e=>{(x.H.changedCore(e,["http.proxy","http.proxyStrictSSL"])||x.H.changed(e,["outputLevel","proxy"]))&&this.resetCaches()})}dispose(){this._disposable.dispose()}resetCaches(){this._proxyAgent=null,this._defaults.clear(),this._enterpriseVersions.clear()}_proxyAgent=null;get proxyAgent(){if(!D.HZ)return null===this._proxyAgent&&(this._proxyAgent=(0,S.cQ)()),this._proxyAgent}async getCurrentAccount(e,t,r){let i=(0,O.dQ)();try{let o=`query getCurrentAccount($avatarSize: Int) {
...
}`,n=await this.graphql(e,t,o,{...r},i);if(n?.viewer==null)return;return{provider:e,name:n.viewer.name??void 0,email:n.viewer.email??void 0,avatarUrl:!n.viewer.avatarUrl||K(r)?n.viewer.avatarUrl??void 0:n.viewer.email&&r?.baseUrl!=null?await this.createEnterpriseAvatarUrl(e,t,r.baseUrl,n.viewer.email,r.avatarSize):void 0,username:n.viewer.login??void 0}}catch(t){if(t instanceof E.g3)return;throw this.handleException(t,e,i)}}async getAccountForCommit(e,t,r,i,o,n){let s=(0,O.dQ)();try{let a=`query getAccountForCommit(
	$owner: String!
	$repo: String!
	$ref: GitObjectID!
	$avatarSize: Int
...
}`,l=await this.graphql(e,t,a,{...n,owner:r,repo:i,ref:o},s),u=l?.repository?.object?.author;if(null==u)return;return{provider:e,name:u.name??void 0,email:u.email??void 0,avatarUrl:!u.avatarUrl||K(n)?u.avatarUrl??void 0:u.email&&n?.baseUrl!=null?await this.createEnterpriseAvatarUrl(e,t,n.baseUrl,u.email,n.avatarSize):void 0,username:u.user?.login??void 0}}catch(t){if(t instanceof E.g3)return;throw this.handleException(t,e,s)}}async getAccountForEmail(e,t,r,i,o,n){let s=(0,O.dQ)();try{let a=`query getAccountForEmail(
	$emailQuery: String!
	$avatarSize: Int
) {
...
}`,l=await this.graphql(e,t,a,{...n,owner:r,repo:i,emailQuery:`in:email ${o}`},s),u=l?.search?.nodes?.[0];if(null==u)return;return{provider:e,name:u.name??void 0,email:u.email??void 0,avatarUrl:!u.avatarUrl||K(n)?u.avatarUrl??void 0:u.email&&n?.baseUrl!=null?await this.createEnterpriseAvatarUrl(e,t,n.baseUrl,u.email,n.avatarSize):void 0,username:u.login??void 0}}catch(t){if(t instanceof E.g3)return;throw this.handleException(t,e,s)}}async getDefaultBranch(e,t,r,i,o){let n=(0,O.dQ)();try{let s=`query getDefaultBranch(
	$owner: String!
	$repo: String!
) {
	repository(name: $repo, owner: $owner) {
...
}`,a=await this.graphql(e,t,s,{...o,owner:r,repo:i},n),l=a?.repository?.defaultBranchRef?.name??void 0;if(null==l)return;return{provider:e,name:l}}catch(t){if(t instanceof E.g3)return;throw this.handleException(t,e,n)}}async getIssueOrPullRequest(e,t,r,i,o,n){let s=(0,O.dQ)();try{let a=`query getIssueOrPullRequest(
	$owner: String!
	$repo: String!
	$number: Int!
) {
...
}`,a=await this.graphql(void 0,e,s,{owner:t,repo:r,ref:i,path:o},n);if(null==a)return Y;let l=a.repository?.object?.blame?.ranges;if(null==l||0===l.length)return{ranges:[],viewer:a.viewer?.name};return{ranges:l,viewer:a.viewer?.name}}catch(e){if(e instanceof E.g3)return Y;throw this.handleException(e,void 0,n)}}async getBranches(e,t,r,i){let o=(0,O.dQ)();try{let n=`query getBranches(
	$owner: String!
	$repo: String!
	$branchQuery: String
	$cursor: String
...
}`,s=await this.graphql(void 0,e,n,{owner:t,repo:r,branchQuery:i?.query,cursor:i?.cursor,limit:Math.min(100,i?.limit??100)},o);if(null==s)return Q;let a=s.repository?.refs;if(null==a)return Q;return{paging:{cursor:a.pageInfo.endCursor,more:a.pageInfo.hasNextPage},values:a.nodes}}catch(e){if(e instanceof E.g3)return Q;throw this.handleException(e,void 0,o)}}async getCommit(e,t,r,i){let o=(0,O.dQ)();try{let n=await this.request(void 0,e,"GET /repos/{owner}/{repo}/commits/{ref}",{owner:t,repo:r,ref:i},o),s=n?.data;if(null==s)return;let{commit:a}=s;return{oid:s.sha,parents:{nodes:s.parents.map(e=>({oid:e.sha}))},message:a.message,additions:s.stats?.additions,changedFiles:s.files?.length,deletions:s.stats?.deletions,author:{avatarUrl:s.author?.avatar_url??void 0,date:a.author?.date??new Date().toString(),email:a.author?.email??void 0,name:a.author?.name??""},committer:{date:a.committer?.date??new Date().toString(),email:a.committer?.email??void 0,name:a.committer?.name??""},files:s.files}}catch(e){if(e instanceof E.g3)return;throw this.handleException(e,void 0,o)}}async getCommitForFile(e,t,r,i,o){if((0,I.HH)(i))return this.getCommit(e,t,r,i);let n=await this.getCommits(e,t,r,i,{limit:1,path:o});if(0!==n.values.length)return{...await this.getCommit(e,t,r,n.values[0].oid)??n.values[0],viewer:n.viewer}}async getCommitBranches(e,t,r,i,o,n){let s=(0,O.dQ)();try{let a=`query getCommitBranches(
	$owner: String!
	$repo: String!
	$since: GitTimestamp!
	$until: GitTimestamp!
...
}`,l=await this.graphql(void 0,e,a,{owner:t,repo:r,since:n?.toISOString(),until:n?.toISOString()},s),u=l?.repository?.refs?.nodes;if(null==u)return[];let c=[];for(let e of u)for(let t of e.target.history.nodes)if(i.includes(t.oid)){c.push(e.name);break}return c}catch(e){if(e instanceof E.g3)return[];throw this.handleException(e,void 0,s)}}async getCommitCount(e,t,r,i){let o=(0,O.dQ)();try{let n=`query getCommitCount(
	$owner: String!
	$repo: String!
	$ref: String!
) {
...
}`,s=await this.graphql(void 0,e,n,{owner:t,repo:r,ref:i},o);return s?.repository?.ref?.target.history.totalCount}catch(e){if(e instanceof E.g3)return;throw this.handleException(e,void 0,o)}}async getCommitOnBranch(e,t,r,i,o,n,s){let a=(0,O.dQ)();try{let l=`query getCommitOnBranch(
	$owner: String!
	$repo: String!
	$ref: String!
	$since: GitTimestamp!
...
}`,u=await this.graphql(void 0,e,l,{owner:t,repo:r,ref:`refs/heads/${i}`,since:s?.toISOString(),until:s?.toISOString()},a),c=u?.repository?.ref.target.history.nodes;if(null==c)return[];let d=[];for(let e of c)if(o.includes(e.oid)){d.push(i);break}return d}catch(e){if(e instanceof E.g3)return[];throw this.handleException(e,void 0,a)}}async getCommits(e,t,r,i,o){let n=(0,O.dQ)();if(o?.limit===1&&o?.path==null)return this.getCommitsCoreSingle(e,t,r,i);try{let s;let a=`query getCommits(
	$owner: String!
	$repo: String!
	$ref: String!
	$path: String
...
}`,s=await this.graphql(void 0,e,n,{owner:t,repo:r,ref:i},o);if(null==s)return Q;let a=s.repository?.object;return null!=a?{values:[a],viewer:s.viewer.name}:Q}catch(e){if(e instanceof E.g3)return Q;throw this.handleException(e,void 0,o)}}async getCommitRefs(e,t,r,i,o){let n=(0,O.dQ)();try{let s=`query getCommitRefs(
	$owner: String!
	$repo: String!
	$ref: String!
	$after: String
...
}`,a=await this.graphql(void 0,e,s,{owner:t,repo:r,ref:i,path:o?.path,first:o?.first,last:o?.last,after:o?.after,before:o?.before,since:o?.since,until:o?.until},n),l=a?.repository?.object?.history;if(null==l)return;return{pageInfo:l.pageInfo,totalCount:l.totalCount,values:l.nodes}}catch(e){if(e instanceof E.g3)return;throw this.handleException(e,void 0,n)}}async getCommitTags(e,t,r,i,o){let n=(0,O.dQ)();try{let s=`query getCommitTags(
	$owner: String!
	$repo: String!
	$since: GitTimestamp!
	$until: GitTimestamp!
...
}`,a=await this.graphql(void 0,e,s,{owner:t,repo:r,since:o.toISOString(),until:o.toISOString()},n),l=a?.repository?.refs?.nodes;if(null==l)return[];let u=[];for(let e of l)for(let t of e.target.history.nodes)if(t.oid===i){u.push(e.name);break}return u}catch(e){if(e instanceof E.g3)return[];throw this.handleException(e,void 0,n)}}async getNextCommitRefs(e,t,r,i,o,n){let s;let a=await this.getCommitDate(e,t,r,n);if(null==a)return[];let l=await this.getCommitRefs(e,t,r,i,{path:o,first:1,since:a});if(null==l)return[];let u=`${l.pageInfo.startCursor.split(" ",1)[0]} ${l.totalCount}`;if([,s]=u.split(" ",2),s=Math.min(parseInt(s,10),5),null==(l=await this.getCommitRefs(e,t,r,i,{path:o,last:s,before:u})))return[];let c=[];for(let{oid:e}of l.values){if(e===n)break;c.push(e)}return c.reverse()}async getCommitDate(e,t,r,i){let o=(0,O.dQ)();try{let n=`query getCommitDate(
	$owner: String!
	$repo: String!
	$sha: GitObjectID!
) {
...
}`,s=await this.graphql(void 0,e,n,{owner:t,repo:r,sha:i},o);return s?.repository?.object?.committer.date}catch(e){if(e instanceof E.g3)return;throw this.handleException(e,void 0,o)}}async getContributors(e,t,r){let i=(0,O.dQ)();try{let o=await this.request(void 0,e,"GET /repos/{owner}/{repo}/contributors",{owner:t,repo:r,per_page:100},i),n=o?.data;if(null==n)return[];return o.data}catch(e){if(e instanceof E.g3)return[];throw this.handleException(e,void 0,i)}}async getDefaultBranchName(e,t,r){let i=(0,O.dQ)();try{let o=`query getDefaultBranch(
	$owner: String!
	$repo: String!
) {
	repository(owner: $owner, name: $repo) {
...
}`,n=await this.graphql(void 0,e,o,{owner:t,repo:r},i);if(null==n)return;return n.repository?.defaultBranchRef?.name??void 0}catch(e){if(e instanceof E.g3)return;throw this.handleException(e,void 0,i)}}async getCurrentUser(e,t,r){let i=(0,O.dQ)();try{let o=`query getCurrentUser(
	$owner: String!
	$repo: String!
) {
	viewer { name, email, login, id }
	repository(owner: $owner, name: $repo) { viewerPermission }
}`,n=await this.graphql(void 0,e,o,{owner:t,repo:r},i);if(null==n)return;return{name:n.viewer?.name,email:n.viewer?.email,username:n.viewer?.login,id:n.viewer?.id}}catch(e){if(e instanceof E.g3)return;throw this.handleException(e,void 0,i)}}async getRepositoryVisibility(e,t,r){let i=(0,O.dQ)();try{let o=`query getRepositoryVisibility(
	$owner: String!
	$repo: String!
) {
	repository(owner: $owner, name: $repo) {
...
}`,n=await this.graphql(void 0,e,o,{owner:t,repo:r},i);if(n?.repository?.visibility==null)return;return"PUBLIC"===n.repository.visibility?"public":"private"}catch(e){if(e instanceof E.g3)return;throw this.handleException(e,void 0,i)}}async getTags(e,t,r,i){let o=(0,O.dQ)();try{let n=`query getTags(
	$owner: String!
	$repo: String!
	$tagQuery: String
	$cursor: String
	...
	mentioned: search(first: 100, query: $mentioned, type: ISSUE) {
		nodes {
...
}`,a=r?.search?.trim()??"";if(r?.user&&(a+=` user:${r.user}`),r?.repos!=null&&r.repos.length>0){let e="  repo:";a+=`${e}${r.repos.join(e)}`}let l="is:pr is:open archived:false",u=await this.graphql(e,t,s,{authored:`${a} ${l} author:@me`.trim(),assigned:`${a} ${l} assignee:@me`.trim(),reviewRequested:`${a} ${l} review-requested:@me`.trim(),mentioned:`${a} ${l} mentions:@me`.trim(),baseUrl:r?.baseUrl},o,i);if(void 0===u)return[];return Z([...u.assigned.nodes.map(e=>n(e,"assigned")),...u.reviewRequested.nodes.map(e=>n(e,"review-requested")),...u.mentioned.nodes.map(e=>n(e,"mentioned")),...u.authored.nodes.map(e=>n(e,"authored"))],e=>e.pullRequest.url)}catch(t){throw this.handleException(t,e,o)}}async searchMyIssues(e,t,r,i){let o=(0,O.dQ)(),n=`query searchIssues(
				$authored: String!
				$assigned: String!
				$mentioned: String!
			) {
			...
			}`,s=r?.search?.trim()??"";if(r?.user&&(s+=` user:${r.user}`),r?.repos!=null&&r.repos.length>0){let e="  repo:";s+=`${e}${r.repos.join(e)}`}let a="type:issue is:open archived:false";try{let l=function(t,r){return{issue:(0,L.fromGitHubIssueDetailed)(t,e),reasons:r?[r]:[]}},u=await this.graphql(e,t,n,{authored:`${s} ${a} author:@me`.trim(),assigned:`${s} ${a} assignee:@me`.trim(),mentioned:`${s} ${a} mentions:@me`.trim(),baseUrl:r?.baseUrl},o,i);if(void 0===u)return[];return Z([...u.assigned.nodes.map(e=>l(e,"assigned")),...u.mentioned.nodes.map(e=>l(e,"mentioned")),...u.authored.nodes.map(e=>l(e,"authored"))],e=>e.issue.url)}catch(t){throw this.handleException(t,e,o)}}async mergePullRequest(e,t,r,i,o,n){let s;let a=(0,O.dQ)();switch(o?.mergeMethod){case U.e0.Merge:s="MERGE";break;case U.e0.Rebase:s="REBASE";break;case U.e0.Squash:s="SQUASH"}try{let l=`mutation mergePullRequest(
	$id: ID!
